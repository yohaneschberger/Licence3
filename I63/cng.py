...
def current_color(*args):
    ...
    if len(args) == 1:
        if isinstance(args[0], str):
            ...
            __erreur("[current_color] le param̬tre n'est pas une chaine")
    # 3 parametres : code RVB sur [0, 255]
        ...
        if isinstance(args[0], int) and isinstance(args[1], int) and isinstance(args[2], int):
            ...
            __erreur("[current_color] l'un des param̬tres n'est pas un entier")
    # erreur : nombre de parametres incorrect
    else:
        __erreur("[current_color] nombre de param̬tres incorrect (1 ou 3)")
